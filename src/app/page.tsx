...
{`  _____                _     ______ __  __ 
 ...
 |_|  \\_\\___/ \\__,_|___/\\__| |_|    |_|  |_|`}
                        ...
                        >
                            {isLoading ? (
                                <>
                                    <div className="inline-block w-5 h-5 mr-2 border-2 border-[#00FF00] border-t-transparent animate-spin"></div>
                                    CONNECTING...
                                </>
                            ) : (
            ...
            <footer className="w-full py-6 text-center text-[#00FF00] text-sm font-mono border-t border-[#00FF00]">
